...
public class SeamCarver {
     ...
     *
     * @param x column of picture
     * @param y row of picture
     ...
     *
     * @param a sequence of row indices (one per each col) for the seam to remove
     */
    // remove horizontal seam from current picture
     ...
     *
     * @param a sequence of col indices (one per each row) for the seam to remove
     */
    // remove vertical   seam from current picture
